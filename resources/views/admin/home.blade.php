                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div class="card-info">
                                    ...
                                    <div class="d-flex align-items-end mb-2">
                                        <h4 class="card-title mb-0 me-2">مستخدم {{$allUsers}}</h4>
                                    </div>
                                </div>
                                <div class="card-icon">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div class="card-info">
                                    ...
                                    <div class="d-flex align-items-end mb-2">
                                        <h4 class="card-title mb-0 me-2">{{$users}} عميل</h4>
                                    </div>
                                </div>
                                <div class="card-icon">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div class="card-info">
                                    ...
                                    <div class="d-flex align-items-end mb-2">
                                        <h4 class="card-title mb-0 me-2">{{$userServiceProvider}} موفر خدمة</h4>
                                    </div>
                                </div>
                                <div class="card-icon">
