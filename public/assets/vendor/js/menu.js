        ...
        var l = ["transitionend", "webkitTransitionEnd", "oTransitionEnd"], a = function () {
            ...
            return t = e, o = [{
                ...
                key: "_toggleDropdown", value: function (t, n, i) {
                    ...
                    if (t) {
                        ...
                        var l = Math.round(this._wrapper.getBoundingClientRect().width), a = this._innerPosition,
                            u = this._getItemOffset(n), d = Math.round(n.getBoundingClientRect().width);
                ...
                key: "_findUnopenedParent", value: function (t, n) {
                    ...
                    for (var r = 0, s = (i = i.slice(0, i.indexOf(o))).length; r < s; r++) if (i[r].classList.add("open"), this._accordion) for (var l = e._findChild(i[r].parentNode, ["menu-item", "open"]), a = 0, u = l.length; a < u; a++) if (l[a] !== i[r] && (l[a].classList.remove("open"), n)) for (var d = l[a].querySelectorAll(".menu-item.open"), c = 0, h = d.length; c < h; c++) d[c].classList.remove("open");
                    return o
                }
            }, {
