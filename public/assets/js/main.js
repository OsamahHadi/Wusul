...
document.getElementById("layout-menu") && (isHorizontalLayout = document.getElementById("layout-menu").classList.contains("menu-horizontal")), function () {
    let d = document.querySelectorAll("#layout-menu"), u = (d.forEach(function (e) {
        menu = new Menu(e, {
    ...
    if (l.length) {
        ...
        for (let e = 0; e < t.length; e++) t[e].addEventListener("click", function () {
            let e = this.getAttribute("data-language"), t = this.querySelector(".flag-icon").getAttribute("class"),
    ...
    const m = document.querySelector(".dropdown-notifications-all"),
        c = document.querySelectorAll(".dropdown-notifications-read"), p = (m && m.addEventListener("click", e => {
            c.forEach(e => {
        ...
        }), document.querySelectorAll(".dropdown-notifications-archive")), g = (p.forEach(t => {
            t.addEventListener("click", e => {
                t.closest(".dropdown-notifications-item").remove()
            })
        }), [].slice.call(document.querySelectorAll('[data-bs-toggle="tooltip"]'))), w = (g.map(function (e) {
